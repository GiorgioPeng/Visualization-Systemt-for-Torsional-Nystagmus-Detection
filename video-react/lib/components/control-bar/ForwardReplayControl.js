...
var propTypes = {
  ...
  seconds: _propTypes["default"].oneOf([0.33, 5, 10, 30])
};
var defaultProps = {
  seconds: 10
};
    ...
    function (_Component) {
      ...
      (0, _createClass2["default"])(ForwardReplayControl, [{
        ...
        value: function render() {
          ...
          classNames.push("video-react-icon-".concat(mode, "-").concat(parseInt(seconds)), "video-react-".concat(mode, "-control"));
          ...
          // }, "".concat(mode, " ").concat(parseInt(seconds), " seconds")));
          return _react["default"].createElement("button", {
            ref: function ref(c) {
              _this2.button = c;
            },
